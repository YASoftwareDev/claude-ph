...
argument-hint: [terms] | -i | --full | --width N | --copy N|ID | --show N|ID | --clip | --json | --project NAME | --since DATE | --until DATE | --days N | --no-dedup | --oldest | --regex P | --projects
allowed-tools: Bash(python3:*)
---

!`python3 ~/.claude/scripts/ph.py --width 280 $ARGUMENTS`
